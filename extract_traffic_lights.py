# Description: Extracting traffic lights

import cv2
# metod for object detection
...
# Keep track of the number of image files that were
file_count = 0

# Display a count of the number of the number of images we need to process
    ...
    if (file_count % 10) == 0:
        ...
        for idx in range(len(out['boxes'])):
            ...
            if obj_class == object_detection.LABEL_TRAFFIC_LIGHT:
                ...
                # Increment the number of traffic_lights by 1
